...
export default function LandingPage({ onStartOnboarding, onLoginDirectly }: LandingPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#0a0e1a] text-slate-100 font-sans selection:bg-amber-500/20 selection:text-white" id="landing-container">
      
      {/* 1. SEÇÃO DE CONDIÇÃO ESPECIAL (PRE-HEADER ALERT) */}
      <div className="bg-gradient-to-r from-amber-600/30 via-slate-900 to-amber-600/30 text-slate-300 px-4 py-2 sm:py-2.5 text-center text-[11px] sm:text-xs tracking-wider flex items-center justify-center gap-2 border-b border-white/[0.04] relative z-50">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-40 transition-all duration-300 ${
        isSticky 
          ? 'bg-[#0a0e1a]/90 shadow-2xl shadow-indigo-950/10 border-b border-white/[0.06] backdrop-blur-xl' 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start space-y-7 text-left">
              ...
              {/* Precise Subheadline */}
              <p className="text-slate-400 text-sm sm:text-base md:text-lg leading-relaxed font-normal max-w-2xl">
                A <strong className="text-white">Athena</strong> analisa editais completos, mapeia suas fraquezas em tempo real e calcula automaticamente uma estratégia de estudos de alta performance baseada rigorosamente no perfil da banca <strong className="text-[#F97316]">CEBRASPE</strong>. Estude o conteúdo certo, recorde antes de esquecer e treine com a penalidade real de prova.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto pt-3">
                <button 
                  onClick={onStartOnboarding}
                  className="px-8 py-4 text-sm sm:text-base font-bold text-slate-950 bg-amber-400 hover:bg-amber-300 rounded-xl flex items-center justify-center gap-2 hover:scale-[1.015] shadow-lg shadow-amber-500/10 transition-all cursor-pointer"
                >
                ...
                <a 
                  ...
                  className="px-6 py-4 text-sm font-semibold text-slate-300 border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.06] hover:text-white rounded-xl text-center shadow-sm transition-all text-sm flex items-center justify-center gap-2"
                >
              ...
              {/* Trust signals */}
              <div className="flex items-center gap-6 pt-2 font-mono text-[10.5px] text-slate-500">
                <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5 text-emerald-500" /> Sem cartão requerido</span>
                <span className="flex items-center gap-1.5"><Check className="w-3.5 h-3.5 text-emerald-500" /> Teste imediato de 7 dias</span>
              </div>
            </div>

            {/* Right Column: Dynamic Mockup Visualization */}
            <div className="lg:col-span-5 mt-14 lg:mt-0 relative" id="hero-interactive-dashboard">
              <div className="relative p-2.5 bg-white/[0.02] border border-white/[0.08] rounded-[24px] shadow-2xl">
                <div className="absolute inset-0 bg-gradient-to-tr from-amber-500/5 to-transparent rounded-[24px] pointer-events-none" />
                
                {/* Dynamic Screen simulation */}
                <div className="bg-[#0b101f] border border-white/[0.04] rounded-[18px] overflow-hidden text-left pb-4 relative">
                  
                  {/* Dashboard header mock */}
                  <div className="bg-[#0f152b] p-4 text-white flex items-center justify-between border-b border-white/[0.04]">
                    <div>
                      <span className="text-[8px] font-mono tracking-widest text-slate-500 uppercase block">PAINEL DE ESTUDO ATIVO</span>
                      <h4 className="font-bold text-xs mt-0.5 flex items-center gap-1.5">
                        <UserCheck className="w-3.5 h-3.5 text-amber-500" /> Carlos Henrique • Aluno PRF
                      </h4>
                    </div>
                    <div className="bg-amber-500/10 border border-amber-500/30 px-2 py-1 rounded text-right">
                      <span className="text-[7px] font-mono block text-amber-400 font-bold leading-none">RETENÇÃO REAL</span>
                      <strong className="text-amber-400 font-mono text-xs block mt-0.5">84.2%</strong>
                    </div>
                  </div>

                  {/* Core Simulated State stats */}
                  <div className="p-3 grid grid-cols-2 gap-2">
                    <div className="bg-white/[0.02] border border-white/[0.04] p-3 rounded-xl flex flex-col justify-between h-20">
                      <span className="text-[8px] font-mono text-slate-500 block uppercase">Nível de Aprovação</span>
                      <div className="flex items-baseline gap-1 mt-1">
                        <span className="text-base font-extrabold text-amber-400 font-mono">78%</span>
                        <span className="text-[8px] text-emerald-450 text-emerald-400 font-mono font-bold">+4.3% p/ semana</span>
                      </div>
                    </div>
                    
                    <div className="bg-white/[0.02] border border-white/[0.04] p-3 rounded-xl flex flex-col justify-between h-20">
                      <span className="text-[8px] font-mono text-slate-500 block uppercase">Próximo Simulado</span>
                      <div className="flex items-center gap-1.5 mt-1">
                        <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
                        <span className="text-xs font-bold text-slate-205">Cebraspe Modelo IV</span>
                      </div>
                    </div>
                  </div>

                  {/* Mentorship alert simulation bubble */}
                  <div className="mx-3 p-3 bg-white/[0.01] border border-white/[0.06] rounded-xl text-left space-y-2">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 rounded-full bg-amber-505/20 bg-amber-500/20 text-amber-500 flex items-center justify-center text-[10px] font-bold">🦉</div>
                      <span className="text-[8.5px] font-mono uppercase text-amber-400 font-bold tracking-wider">Athena AI Insight:</span>
                    </div>
                    <p className="text-[10px] text-slate-400 leading-relaxed italic">
                      "Detectamos fragilidade em Física Aplicada (Cinemática Colisão). O cronograma desta semana gerou um reforço ativo com 12 questões estratégicas e 4 novos cartões de retenção."
                    </p>
